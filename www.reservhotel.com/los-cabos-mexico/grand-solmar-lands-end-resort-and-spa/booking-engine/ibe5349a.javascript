    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=34004&lang=1&conf=" + response;
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=34004&lang=1&conf=" + response + "&lastname=" + $("#lastname3").val();
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=34004&lang=1&conf=" + response + "&lastname=" + $("#lastname2").val();
            }
        }
    });
    return false;
...
ageOption+='<option value="11">11</option>';
    ...
    function parse_rates(xml) {   
        ...
        $.ajax({
            type: "GET",            
            async: false,
            url: "/hotel_fastlink_js/34004.xml",
            dataType: "xml",
...
$('#suggest_hotels_content').append(resp);
    ...
    if ($('#long-range-datepicker').length > 0) {
        ...
        $(document).on('click', '.ui-datepicker-unselectable', function(e){
            ...
            if (firstTime > 0){
$('#error_message_content').empty().append('<p class="center a95f5f">Your selection is unavailable. Please choose another date or call +52  1433535 for possible limited inventory.</p>');
}
 var OK = false;  
                                            var show = false;
