    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=34077&lang=1&conf=" + response;
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=34077&lang=1&conf=" + response + "&lastname=" + $("#lastname3").val();
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=34077&lang=1&conf=" + response + "&lastname=" + $("#lastname2").val();
            }
        }
    });
    return false;
...
var cur_conv = 1;
    ...
    $('#next-step').on('click', function(event){
        ...
        var ageBox='';
        var ageOption='';
        var today = new Date(2021,3,15);
        var aD = new Date(2021,4,17);
...
ageOption+='<option value="11">11</option>';
    ...
    function parse_rates(xml) {   
        ...
        $.ajax({
            type: "GET",            
            async: false,
            url: "/hotel_fastlink_js/34077.xml",
            dataType: "xml",
        ...
        $.ajax({
            ...
            data: {
                ...
                xStartDate: startDate?startDate:'15-APR-21',
...
xShowPrices: 'N',
    ...
    if ($('.travel-calendar').length > 0) {
        ...
        var temp1 = new Date(2021,4,17);
        var temp2 = new Date(2021,4,24);
var temp3 = new Date();

        var temp4 = new Date(2021,5,15);
                        ...
                        if (check_the_date(curL, unavail_v2)){
                            ...
                            if (+cur === +_selected_date) {
                                ...
                                if (stopDate!=curDate.getTime()) {
                                    if (firstTime >= 0){
$('#error_message_content').empty().append('<p class="center a95f5f">Your selection is unavailable. Please choose another date or call +52  1444500 for possible limited inventory.</p>');
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34003&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PLAYA GRANDE RESORT AND SPA</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34004&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">GRAND SOLMAR LANDS END RESORT AND SPA</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34005&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">SOLMAR RESORT AND BEACH CLUB</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34006&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">THE RIDGE AT PLAYA GRANDE</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34007&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">QUINTA DEL SOL BY SOLMAR</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34094&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">RANCHO SAN LUCAS RESIDENCES</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34093&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">RANCHO SAN LUCAS GRAND SOLMAR</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34119&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HOMES AND VILLAS BY GRAND SOLMAR	</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34003&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PLAYA GRANDE RESORT AND SPA</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34004&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">GRAND SOLMAR LANDS END RESORT AND SPA</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34005&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">SOLMAR RESORT AND BEACH CLUB</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34006&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">THE RIDGE AT PLAYA GRANDE</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34007&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">QUINTA DEL SOL BY SOLMAR</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34094&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">RANCHO SAN LUCAS RESIDENCES</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34093&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">RANCHO SAN LUCAS GRAND SOLMAR</p></a>';
...
xShowPrices: 'N',
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=34119&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HOMES AND VILLAS BY GRAND SOLMAR	</p></a>';
